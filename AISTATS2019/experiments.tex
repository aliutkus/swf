...
% We note that, once the algorithm is run for $K$ iterations, we can generate new particles by using the CDFs and QFs of the existing particles and then using them for any other new particle.
...
% \vspace{-10pt}
\begin{centering}
\includegraphics[width=0.9\columnwidth]{SW2_cost-crop.pdf}
\par\end{centering}
...
\centering
\subfigure[MNIST]{
\includegraphics[width=\columnwidth]{mnist.pdf}
\label{fig:mnist}
}\hfill
\subfigure[Fashion MNIST]{
\includegraphics[width=\columnwidth]{fmnist2.pdf}
