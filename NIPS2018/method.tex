...
\begin{thm}
Let $\mu_t$ be a generalized minimizing movement scheme given by Theorem~\umut{num} in the supplementary document. We denote by $\rho_t$ the density of $\mu_t$. Then $\rho_t$ satisfies the continuity equation:
\begin{align}
