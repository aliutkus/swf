...
% \vspace{-10pt}
    \begin{minipage}{0.52\textwidth}
     \begin{algorithm2e} [H]
		 ...
		 $\bar{X}_0^i \sim \mu_0$, \hfill $i = 1,\dots,N$ \\%{\color{purple} \small \tcp{Initialize the particles}}  
		 \For{$k = 0,\dots K-1$}{
