...
% the error of the infinite-particle is bounded for all $K$ and the the bound has two terms, one increasing as $\sqrt{K}$ and the other one exponentially decreasing with $K$. Therefore, 
