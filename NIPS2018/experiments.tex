...
% $\SW \leq \W \leq \SW^{{\cal O}(1/d)}$ (cf.\ \cite{bonnotte2013unidimensional,santambrogio2015optimal}).
%
% <<<<<<< HEAD
...
% however, some of the fine-grained textures are not captured by the method
