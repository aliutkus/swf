...
\begin{thm}
Let $(\mu_t)_{t \geq 0}$ be a generalized minimizing movement scheme given by Theorem~\ref{thm:existance_gmm_scheme} with initial distribution $\mu_0$ with density $\rho_0 \in \mrl(\cB(0,r))$. We denote by $\rho_t$ the denisty of $\mu_t$ for all $t \geq 0$. Then $\rho_t$ satisfies the continuity equation:
\[
