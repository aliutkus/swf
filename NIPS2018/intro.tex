...
Implicit generative modeling \cite{diggle1984monte, mohamed2016learning} has become very popular recently and has proven
...
%
It has been shown that these implicit models have close connections to the theory of Optimal Transport (OT) \cite{villani2008optimal}, which  


in which such distances between distributions arise naturally.

 as minimizing the so-called Wasserstein distance between the output distribution and the target $\nu$. More specifically, GAN and VAE were shown to tackle the same problem in a dual way \cite{bousquet2017optimal,genevay2017gan}. 
