...
# streaming version
python streamIDT.py FashionMNIST  --memory_usage 1 --root_data_dir qsketch/data/FashionMNIST --num_quantiles 200  --projectors RandomProjectors  --input_dim 500 --num_samples 3000  --plot --stepsize 100 --reg 0.0001 --batchsize 5 --plot_dir samples_fmnist_stream
