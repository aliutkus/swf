...
# streaming version
# python streamIDT.py FashionMNIST  --memory_usage 2 --root_data_dir qsketch/data/FashionMNIST  --clip 5000 --num_quantiles 100  --projectors RandomProjectors  --input_dim 2000 --num_samples 3000 --plot_target toydata.npy --plot --stepsize 300 --reg 0.0001 --num_thetas 500 --plot_dir samples_fmnist_stream
