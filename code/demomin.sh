...
python swmin.py $1 --root_data_dir ~/data/$1 --img_size 32 --num_sketches $NUM_SKETCHES --clip $CLIPTO --num_quantiles $NUM_QUANTILES --input_dim $INPUT_DIM --num_samples $NUM_SAMPLES --stepsize $STEPSIZE --num_thetas $NUM_THETAS --plot_dir ~/samples_$1 --logdir logs/$1 --plot_every 50 --ae_model ae.model
