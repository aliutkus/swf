...
\centering
\subfigure[MNIST]{
\includegraphics[width=0.85\columnwidth]{figures/MNIST_train_image_1000.png}
\label{fig:mnist}
}
\hfill
\subfigure[Fashion MNIST]{
\includegraphics[width=0.85\columnwidth]{figures/FashionMNIST_train_image_1000.png}
...
Our goal in these experiments is to capture the structure of the data distribution such that the particles that are generated by the algorithm will be samples from this unknown data distribution. In these experiments, we set $\lambda=10^{-6}$ and $N_\theta=16000$.
