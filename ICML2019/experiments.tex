...
\begin{tikzpicture}[font=\small]
	...
	\addplot [forget plot] graphics [xmin=-10,xmax=-2,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0000-crop.pdf};
	\addplot [forget plot] graphics [xmin=0.0,xmax=8,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0003-crop.pdf};
	\addplot [forget plot] graphics [xmin=7.5,xmax=16,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0005-crop.pdf};
	\addplot [forget plot] graphics [xmin=15.5,xmax=24,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0008-crop.pdf};
	\addplot [forget plot] graphics [xmin=23.5,xmax=32,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0010-crop.pdf};
	\addplot [forget plot] graphics [xmin=31.5,xmax=40,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0015-crop.pdf};
	\addplot [forget plot] graphics [xmin=39.5,xmax=48,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0020-crop.pdf};
	\addplot [forget plot] graphics [xmin=47.5,xmax=56,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0030-crop.pdf};
	\addplot [forget plot] graphics [xmin=55.5,xmax=64,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0050-crop.pdf};
	\addplot [forget plot] graphics [xmin=63.5,xmax=72,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0100-crop.pdf};
	\addplot [forget plot] graphics [xmin=71.5,xmax=80,ymin=0,ymax=8] {figures/MNIST_evolution2/particles_train0200-crop.pdf};
	\addplot [forget plot] graphics [xmin=82.0,xmax=90,ymin=0,ymax=8] {figures/MNIST_evolution2/closest0200-crop.pdf};
...
% \vspace{-10pt}
\caption{Initial random particles (left), particles through iterations (middle, from 1 to 201 iterations) and closest sample from the training dataset (right), for both MNIST and FashionMNIST.\label{fig:evolution}}
% \vspace{-10pt}
\end{figure}
